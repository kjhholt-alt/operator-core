"""briefing_midday -- noon checkpoint."""
...
@register_recipe
class BriefingMidday(Recipe):
    name = "briefing_midday"
    version = "1.0.0"
    description = "Midday status checkpoint"
    ...
    async def format(self, ctx: RecipeContext, result: Any) -> str:
        return f"**Midday checkpoint** -- still alive."
